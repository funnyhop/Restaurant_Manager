        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h4 class="ml-3 text-dark" style="font-family: scandia-web">Bàn ăn</h4>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <!-- SEARCH FORM -->
                    ...
                    <div class="row pt-5 pl-4 d-flex">
                        ...
                        <div class="col-10">
                            <table class="table table-bordered text-center table-hover table-info">
                                ...
                                <tbody>
                                    @foreach ($list as $dinnertb)
                                        <tr>
                                            <td>{{ $dinnertb->BanID }}</td>
                                            <td>{{ $dinnertb->SoGhe }}</td>
                                            <td><a href="{{ route('dinnertbs.edit', ['BanID' => $dinnertb->BanID]) }}"><i
                                                        class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td>
                                                <form action="{{ route('dinnertbs.destroy', ['BanID' => $dinnertb->BanID]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
