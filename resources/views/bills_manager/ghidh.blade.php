@extends('layouts.app')
@section('title')
    <title>Danh sách ghi đơn hàng</title>
@endsection
@section('content')
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h4 class="ml-3 text-dark" style="font-family: scandia-web">Danh sách ghi đơn hàng</h4>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <!-- SEARCH FORM -->
                    ...
                    <div class="row pt-5 pl-4 d-flex">
                        ...
                        <div class="col-10">
                            <table class="table table-bordered text-center table-hover table-info">
                                ...
                                <tbody>
                                    @foreach ($list as $ghidh)
                                        <tr>
                                            <td>{{ $ghidh->dish_id }}</td>
                                            <td>{{ $ghidh->order_id }}</td>
                                            <td>{{ $ghidh->SoLuong }}</td>
