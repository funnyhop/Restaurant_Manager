        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h4 class="ml-3 text-dark" style="font-family: scandia-web">Khách hàng</h4>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <!-- SEARCH FORM -->
                                ...
                                <tbody>
                                    @foreach ($list as $customer)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('customers.edit', ['KHID' => $customer->KHID]) }}"><i
                                                        class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td>
                                                <form action="{{ route('customers.edit', ['KHID' => $customer->KHID]) }}" method="post">
                                                    @csrf
                                                    @method('delete')
