        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h4 class="ml-3 text-dark" style="font-family: scandia-web">Phân công</h4>
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                            <!-- SEARCH FORM -->
                                ...
                                <tbody>
                                    @foreach ($list as $assignment)
                                        <tr>
                                            ...
                                            <td>{{ $assignment->dinnertb_id }}</td>
                                            <td>{{ $assignment->day_id }}</td>
                                            <td><a href="{{ route('assignments.edit', ['staff_id' => $assignment->staff_id, 'day_id' => $assignment->day_id, 'dinnertb_id' => $assignment->dinnertb_id]) }}"><i
                                                        class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td>
                                                <form action="{{ route('assignments.edit', ['staff_id' => $assignment->staff_id, 'day_id' => $assignment->day_id, 'dinnertb_id' => $assignment->dinnertb_id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('delete')
